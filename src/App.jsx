...
function ContenidoApp() {
  ...
  return (
    <div style={{ backgroundColor: '#f8fafc', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* HEADER PRINCIPAL */}
      <header className="no-print" style={{ backgroundColor: '#0f172a', color: '#ffffff', padding: '15px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', boxShadow: '0 2px 4px rgba(0,0,0,0.1)' }}>
